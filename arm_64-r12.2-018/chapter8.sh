...
# 8.16. Tcl-8.6.15
# wget https://downloads.sourceforge.net/tcl/tcl8.6.15-src.tar.gz
# wget https://downloads.sourceforge.net/tcl/tcl8.6.15-html.tar.gz
...
# 8.40. Expat-2.6.3
# wget https://prdownloads.sourceforge.net/expat/expat-2.6.3.tar.xz
...
# 8.52. Python-3.12.7
# wget https://www.python.org/ftp/python/doc/3.12.7/python-3.12.7-docs-html.tar.bz2
...
# 8.55. Setuptools-75.1.0
# wget https://pypi.org/packages/source/s/setuptools/setuptools-75.1.0.tar.gz
tar -xf setuptools-75.1.0.tar.gz
cd setuptools-75.1.0
pip3 wheel -w dist --no-cache-dir --no-build-isolation --no-deps $PWD
pip3 install --no-index --find-links dist setuptools
cd ..
rm -f setuptools-75.1.0
...
# wget https://www.kernel.org/pub/linux/utils/net/iproute2/iproute2-6.11.0.tar.xz
tar -xf iproute2-6.11.0.tar.xz
cd iproute2-6.11.0
sed -i /ARPD/d Makefile
rm -fv man/man8/arpd.8
make NETNS_RUN_DIR=/run/netns
make SBINDIR=/usr/sbin install
mkdir -pv             /usr/share/doc/iproute2-6.11.0
cp -v COPYING README* /usr/share/doc/iproute2-6.11.0
cd ..
rm -r iproute2-6.11.0
...
# 8.73. Vim-9.1.0738
# wget https://github.com/vim/vim/archive/v9.1.0738/vim-9.1.0738.tar.gz
tar -xf vim-9.1.0738.tar.gz
cd vim-9.1.0738
...
# 8.76. Udev from Systemd-256.5
# wget https://github.com/systemd/systemd/archive/v256.5/systemd-256.5.tar.gz
# wget https://anduin.linuxfromscratch.org/LFS/udev-lfs-20230818.tar.xz
# wget https://anduin.linuxfromscratch.org/LFS/systemd-man-pages-256.5.tar.xz
...
# 8.77. Man-DB-2.13.0
# wget https://download.savannah.gnu.org/releases/man-db/man-db-2.13.0.tar.xz
...
# 8.81. Sysklogd-2.6.2
# wget https://github.com/troglobit/sysklogd/releases/download/v2.6.2/sysklogd-2.6.2.tar.gz
tar -xf sysklogd-2.6.2.tar.gz
cd sysklogd-2.6.2
./configure --prefix=/usr      \
            --sysconfdir=/etc  \
            --runstatedir=/run \
